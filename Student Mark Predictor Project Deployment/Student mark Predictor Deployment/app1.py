...
app = Flask(__name__)
model = joblib.load(r"D:\DATA SCIENCE NOTES\4. Students mark prediction\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
